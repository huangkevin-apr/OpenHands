...
class V1ConversationService {
   ...
   * @param conversationId The conversation ID
   * @param filePath Path to the file to read within the sandbox workspace (defaults to /workspace/project/.openhands/PLAN.md)
   * @returns The content of the file or an empty string if the file doesn't exist
   */
  static async readConversationFile(
    conversationId: string,
    filePath: string = "/workspace/project/.openhands/PLAN.md",
  ): Promise<string> {
    const params = new URLSearchParams();
