...
function GitSettingsScreen() {
  ...
  // Note: External configure buttons feature is disabled since APP_SLUG is no longer in the API
  const shouldRenderExternalConfigureButtons = false;
          ...
          {shouldRenderExternalConfigureButtons && !isLoading && (
            <>
              <div className="pb-1 flex flex-col">
                ...
                <ConfigureGitHubRepositoriesAnchor slug="openhands" />
              </div>
